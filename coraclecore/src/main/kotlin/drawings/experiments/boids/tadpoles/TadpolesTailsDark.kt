...
class TadpolesTailsDark: Drawing() {
    private var worldColour = 0x1d1d1d
    private val boidColour = 0xffffff
    ...
    private var tadpoleColour = 0xffffff
    ...
    inner class Tadpole(private val id: Int, spawnLocation: Vector?, private val parentId: Int?){
        ...
        fun draw() {
            if(android){
                fill(boidColour, 0.2f)
            }else{
                stroke(boidColour, 0.2f)
            }
            ...
            repeat(tailLength){ tailIndex ->
                ...
                if(android){
                    circle(tailX[tailIndex], tailY[tailIndex], 2)
                } else{
