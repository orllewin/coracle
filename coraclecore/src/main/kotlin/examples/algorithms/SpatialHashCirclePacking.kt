...
class SpatialHashCirclePacking: Drawing() {
    ...
    lateinit var spatialHash: SpatialHash
    val maxRad = 15

    //How many circles to try and add each iteration
    var frameAttempts = 1
    var frame = 0
